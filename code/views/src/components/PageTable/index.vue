<template>
  <div :class="className" class="pageTable">
    <div v-if="$slots.default" ref="header" class="pageTable-header">
      <slot/>
    </div>
    <div ref="body" :style="bodyStyle" class="pageTable-body">
      <Table
        ref="table"
        v-on="$listeners"
    ...
    <div v-if="hasPage" class="pageTable-footer">

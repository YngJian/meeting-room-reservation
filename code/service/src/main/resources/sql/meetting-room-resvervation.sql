...
(
    ...
    `password`    varchar(256) CHARACTER SET utf8mb4 NOT NULL COMMENT '登录密码',
    `phone`       varchar(16) CHARACTER SET utf8mb4  NOT NULL COMMENT '用户手机号',
    `email`       varchar(64) CHARACTER SET utf8mb4  NOT NULL COMMENT '用户邮箱号',
...
(
    ...
    `room_name`   varchar(64) CHARACTER SET utf8mb4 NOT NULL COMMENT '房间名',
    `capacity`    tinyint                           NOT NULL COMMENT '容量',
    `status`      tinyint                           NOT NULL DEFAULT 1 COMMENT '会议室状态：1正常，0禁用',
...
(
  ...
  CHARACTER SET = utf8mb4 COMMENT = '会议室预约信息表';
